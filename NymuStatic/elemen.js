...
Artikel.setAttribute('class', 'col-7-lg mx-auto rounded-3');
JendelaSamping.setAttribute('class', 'col-4-lg mx-auto rounded-3');
Footer.setAttribute('class', 'col-5-md mt-2 mx-auto rounded-3');
