...
Header.setAttribute('class', 'col-12-lg mb-2 rounded-3');
Navbar.setAttribute('class', 'col-12-lg mb-2 rounded-3');
Artikel.setAttribute('class', 'col-7-lg mx-auto mb-2 rounded-3');
JendelaSamping.setAttribute('class', 'col-4-lg mx-auto mb-2 rounded-3');
Footer.setAttribute('class', 'col-5-md mx-auto rounded-3');
