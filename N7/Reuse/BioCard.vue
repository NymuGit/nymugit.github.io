...
<template>
  <div id="bio-card" :class="Cls7.BioCard.Div1 + Color">
    <div :class="Cls7.BioCard.Div2" >
      <h3 :class="Cls7.BioCard.H3">{{ Name }}</h3>
      <i :class="Cls7.BioCard.I">{{ Quote }}</i>
    </div>
